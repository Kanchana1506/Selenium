...
public class Leaftaps {
	...
	public static void main(String[] args) {
		...
		System.setProperty("webdriver.chrome.driver","C:\\Users\\kanch\\Desktop\\MAVEN\\Mavenproject\\Drivers\\Chromedriver\\chromedriver.exe");
	...
	WebElement source = driver.findElementById("createLeadForm_dataSourceId");
		...
		String Leadtitle = driver.getTitle();
				...
				//query: once i run the script by giving name as harry .. can i run the same script again without changing the name ...
				//will duplicate oocur ?
	}
